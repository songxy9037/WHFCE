...
import models
import pywt
from models.SNUNet.Models import SNUNet_ECAM
from models.Xnet import XCDNet
###############################################################################
# Helper Functions
###############################################################################
...
from .WHFCE import WHFCE
from .SCanNet.SCanNet import SCanNet
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    if args.net_G == 'base_resnet18':
        ...
        net = BASE_Transformer(input_nc=3, output_nc=2, with_pos='learned', backbone='resnet34')  # ChangeFormer with Transformer Encoder and Convolutional Decoder
    elif args.net_G == 'SNUNet':
        net = SNUNet_ECAM(3,2)


    elif args.net_G == 'WHFCE':
        net = WHFCE()
    elif args.net_G == 'MDIPNet':
        net = build_model()
    elif args.net_G == 'SCanNet':
        net = SCanNet(3,2,256)
    elif args.net_G == 'AERNet':
        net = AERNet()
    elif args.net_G == 'DMINet':
        net = DMINet()
    elif args.net_G == 'AMTNet':
        net = CDNet()
    elif args.net_G == 'UABCD':
        net = UABCD(6,2)
    elif args.net_G == 'HAFF':
        net = ADVNets(3,2)
