...
def main():
    ...
    parser.add_argument('--checkpoints_root', default='BaseNet_Newdata_Mynet_img5_b20_lr0.0001_train_val_1000_linear', type=str)
    parser.add_argument('--vis_root', default='vis', type=str)

    # data
    parser.add_argument('--num_workers', default=8, type=int)
    parser.add_argument('--dataset', default='img5', type=str)
